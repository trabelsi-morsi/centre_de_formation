...
<h3 class="heading_a">Ajout d'un réglement etudiant</h3>
                        </br>
                    <form id="form_validation" class="uk-form-stacked" method="POST" enctype="multipart/form-data" action='index.php?controller=reglement_etudiant&action=ajout' >
                                    ...
                                    <OPTION value=""></OPTION>
                                         <?php
                                           ...
                                           foreach ($variable as $res) {
                                             ...
                                             echo ' <OPTION value="'.$res->id_ins.'"> '.$res->nom.' '.$res->prenom.'</OPTION> ' ;
                                            }
                                          ?>
                                 </select> 
                           </div>
                        ...
                        <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    <div class="md-input-wrapper"><label id="resultatajax">Montant</label>  <input id="montant" type="number" max="" min="1" required name='montant' class="md-input"  /><span class="md-input-bar"></span></div>    
                                </div>
                         </div>
